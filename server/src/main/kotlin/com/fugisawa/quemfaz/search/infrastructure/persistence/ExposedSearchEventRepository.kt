...
class ExposedSearchEventRepository : SearchEventRepository {
    ...
    override fun logEvents(events: List<SearchEvent>) = transaction {
    ...
    override fun countSearchesInWindow(cityName: String, windowDays: Int): Long = transaction {
        val cutoff = Instant.now().minus(windowDays.toLong(), ChronoUnit.DAYS)
        SearchEventsTable
            .selectAll()
            .where {
