...
class ModerationService(
    ...
    fun getReportDetails(reportId: ReportId): ReportResponse? = reportRepository.findById(reportId)?.let { mapToResponse(it) }
    ...
    private fun mapToResponse(report: ServerReport) =
        ReportResponse(
            id = report.id.value,
