...
class CompleteUserProfileService(
    ...
    fun completeProfile(userId: UserId, request: CompleteUserProfileRequest): CompleteProfileResult = transaction {
...
sealed class CompleteProfileResult {
    data class Success(val response: UserProfileResponse) : CompleteProfileResult()
    data class Failure(val message: String) : CompleteProfileResult()
}
