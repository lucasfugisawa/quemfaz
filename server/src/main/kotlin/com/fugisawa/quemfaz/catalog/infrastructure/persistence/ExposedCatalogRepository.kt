...
private fun ResultRow.toServiceCategory() =
    ServiceCategory(
...
private fun ResultRow.toCatalogServiceRecord() =
...
private fun ResultRow.toUnmatchedSignal() =
...
class ExposedCatalogRepository : CatalogRepository {
    override fun findAllCategories(): List<ServiceCategory> =
        transaction {
    ...
    override fun findServicesByStatus(vararg statuses: CatalogServiceStatus): List<CatalogServiceRecord> =
        transaction {
    ...
    override fun findServiceById(id: String): CatalogServiceRecord? =
        transaction {
            CanonicalServicesTable
                .selectAll()
    ...
    override fun createService(service: CatalogServiceRecord): CatalogServiceRecord =
        transaction {
    ...
    override fun removeServiceFromProfiles(serviceId: String) =
        transaction {
            ProfessionalProfileServicesTable.deleteWhere {
...
class ExposedSignalRepository : SignalRepository {
    override fun create(signal: UnmatchedServiceSignal) =
        transaction {
    ...
    override fun findByProvisionalServiceId(provisionalServiceId: String): List<UnmatchedServiceSignal> =
        transaction {
