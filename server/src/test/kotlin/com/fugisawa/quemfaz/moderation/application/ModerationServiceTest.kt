...
class ModerationServiceTest {
    ...
    private class FakeReportRepository : ReportRepository {
        ...
        override fun save(report: ServerReport) { reports[report.id.value] = report }
    ...
    fun `should block professional profile and resolve report`() {
        ...
        reportRepo.save(ServerReport(reportId, UserId("u2"), com.fugisawa.quemfaz.domain.moderation.ReportTargetType.PROFESSIONAL_PROFILE, profileId.value, com.fugisawa.quemfaz.domain.moderation.ReportReason.SPAM, null, ReportStatus.OPEN, Instant.now(), null, null))
