...
class ImageStorageIntegrationTest : BaseIntegrationTest() {
    ...
    @Test
    fun `should upload image and retrieve it by URL`() =
        integrationTestApplication {
            ...
            val url =
                kotlinx.serialization.json.Json
                    .decodeFromString<com.fugisawa.quemfaz.contract.image.UploadImageResponse>(body)
                    .url
    ...
    @Test
    fun `should reject upload with disallowed MIME type`() =
        integrationTestApplication {
    ...
    @Test
    fun `should reject upload exceeding 5MB`() =
        integrationTestApplication {
    ...
    @Test
    fun `should return 404 for unknown image ID`() =
        integrationTestApplication {
