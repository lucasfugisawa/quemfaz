...
class EngagementCounterIntegrationTest : BaseIntegrationTest() {
    ...
    @Test
    fun `tracking profile view increments view count and updates profile response`() =
        integrationTestApplication {
            ...
            val viewResponse =
                publicClient.post("/engagement/profile-view") {
    ...
    @Test
    fun `tracking contact click increments contact count`() =
        integrationTestApplication {
            ...
            val publicClient = createTestClient()
            val clickResponse =
                publicClient.post("/engagement/contact-click") {
                    contentType(ContentType.Application.Json)
                    setBody(
                        TrackContactClickRequest(
